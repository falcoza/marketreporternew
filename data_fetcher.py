    ...
    try:
        ...
        for label, symbol in tickers.items():
            try:
                ...
                # Get daily data for reliable 1D% changes
                ...
                day_ago_val = daily_hist["Close"].iloc[-2]  # Previous trading day
                
                # Get monthly data using calendar dates
        ...
        # Crypto from CoinGecko (unchanged)
        try:
            cg = CoinGeckoAPI()
