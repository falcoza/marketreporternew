def fetch_market_data() -> Optional[Dict[str, Any]]:
    ...
    try:
        # Use the FTSE/JSE All‑Share Index (^J203.JO) instead of a Satrix ETF
        jse_tickers = ["^J203.JO"]  # Yahoo Finance ticker for FTSE/JSE All‑Share Index :contentReference[oaicite:1]{index=1}
        jse = None
        ...
        if jse is None:
            print("⚠️ Could not fetch FTSE/JSE All‑Share data from ^J203.JO")
            return None
        ...
        # Historical and YTD prices for the index
